...
Currently supports flutter: 3.2.0
...
I kept the code as original as possible with proper Commented Guides for anyone to understand and implement. Still you need to follow these steps.
  ...
  - Now download this [Repo](https://github.com/jinosh05/flutter_localapi_cache/archive/refs/heads/master.zip)
  - Extract the Repo into your newly created **flutter_localapi_cache** and replace the required files.
